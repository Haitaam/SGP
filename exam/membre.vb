...
Public Class membre
    ...
    Public Sub afficher_membre()
        ...
        End If
        If (membre_form.type_operation.Text = "Modifier") Then
            DataGridView1.Rows(Val(membre_form.ligne_modifie.Text)).Selected = True
        End If
    End Sub
    Private Sub DataGridView1_CellDoubleClick1(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        ...
        membre_form.id.Text = DataGridView1.Rows(i).Cells(0).Value.ToString
        membre_form.ancien_membre.Text = DataGridView1.Rows(i).Cells(0).Value
        membre_form.nom.Text = DataGridView1.Rows(i).Cells(1).Value.ToString
        membre_form.prenom.Text = DataGridView1.Rows(i).Cells(2).Value.ToString
        membre_form.email.Text = DataGridView1.Rows(i).Cells(3).Value.ToString
        membre_form.poste.Text = DataGridView1.Rows(i).Cells(4).Value.ToString
        membre_form.ligne_modifie.Text = i
        membre_form.type_operation.Text = "Modifier"
        membre_form.ShowDialog()
    End Sub
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        With e.Graphics
            ...
            .DrawString("Nom", font_tcolonne, Brushes.Black, cl + 80, ln)
            .DrawString("Prenom ", font_tcolonne, Brushes.Black, cl + 200, ln)
            .DrawString("Email ", font_tcolonne, Brushes.Black, cl + 350, ln)
            .DrawString("Poste ", font_tcolonne, Brushes.Black, cl + 600, ln)
        End With
        ln = ln + 20
        e.Graphics.DrawLine(ligne, cl, ln, 750, ln)
        ...
        For i = 0 To DataGridView1.Rows.Count - 1
            ...
            With e.Graphics
                ...
                .DrawString(c5, font_colonne, Brushes.Black, cl + 600, ln)
            End With
            ln = ln + 20
            e.Graphics.DrawLine(ligne, cl, ln, 750, ln)
        Next
        e.Graphics.DrawLine(ligne, cl, 1100, 750, 1100)
        e.Graphics.DrawString("Gestion des membres", font_titre, Brushes.Black, cl, 1100)
    End Sub

    Private Sub Ajouter_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Ajouter.Click
        membre_form.type_operation.Text = "Ajouter"
        membre_form.id.Text = Nothing
        membre_form.nom.Text = Nothing
        membre_form.prenom.Text = Nothing
        membre_form.email.Text = Nothing
        membre_form.poste.Text = Nothing
        membre_form.ShowDialog()
    End Sub
    ...
    Private Sub Supprimer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Supprimer.Click
        ...
        Else
            ...
            rep = MsgBox("Etes-vous sûr de supprimer ce membre : " + id + "? ", vbYesNo + vbQuestion, "Confirmation")
            If (rep = vbYes) Then
                connexion()
    ...
    Private Sub Rechercher_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Rechercher.Click
        ...
        nom_a_chercher = InputBox("Entrez le nom ou le prenom chercher : ", "Recherche", "")
        connexion()
        requete = "select * from Membre where " & _
                  "ucase(nom_membre) like '%" + nom_a_chercher.ToUpper + "%'" & _
                  "or ucase(prenom_membre) like '%" + nom_a_chercher.ToUpper + "%'"
